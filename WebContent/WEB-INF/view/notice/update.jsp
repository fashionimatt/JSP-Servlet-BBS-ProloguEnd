			...
			<table class="col-xl-8 table">
				<tbody>
					<tr>
						...
						<td colspan="3"><input class="form-control" type="text" name="title" value="${notice.title}"/></td>
					</tr>
					<tr>
						<th class="active">작성일</th>
						<td colspan="3"><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${notice.regdate}"/></td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<div class="input-group">
							  <div class="custom-file">
							    ...
							    <label class="custom-file-label" for="inputGroupFile01">${notice.files}</label>
							  </div>
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="4"><textarea class="form-control" rows="7" name="content">${notice.content}</textarea></td>
					</tr>
				</tbody>
			</table>
